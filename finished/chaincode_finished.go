...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	} else if function == "testRanjan" {
		return t.testRanjanMethod(stub, args)
	}
...
func (t *SimpleChaincode) testRanjanMethod(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
